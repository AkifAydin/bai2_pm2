...
public class Wikipedia3DFilmParser0 {
    /*
     ...
     *
     * @param uri eine URI als Zeichenkette dargestellt.
     * @throws MalformedURLException :
     *                               uri ist eine ungültige Darstellung einer URL
     * @throws IOException:          Beim Öffnen des InputStreams einer URL ist ein Fehler
     *                               aufgetreten
     */
    public Wikipedia3DFilmParser0(String uri) throws MalformedURLException, IOException {
     ...
     *
     * @param path eine Pfaddarstellung einer Ressource im Dateisystem
     * @throws MalformedURLException
     * @throws IOException
     */
    public Wikipedia3DFilmParser0(Path path) throws MalformedURLException, IOException {
    ...
    public Map<String, List<String>> contentTo3DFilmsPerYear() {
        ...
        wiki3DFilmScanner.findAll(threeDeeEnum).forEach(c -> {
            String currentDate = c.group(1);
            if (!threeDeeMap.containsKey(currentDate)) {
                ...
                String filmListContent = c.group(2);
     ...
     *
     * @param ulList      Zeichenkette, die die ListItems enthält
     * @param currentDate Zeitangabe, der Schlüssel für das Verzeichnis
     * @param threeDeeMap Verzeichnis, in das zu dem Schlüssel die Liste der geparsten
